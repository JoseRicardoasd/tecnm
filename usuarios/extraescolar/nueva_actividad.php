                  ...
                  <form action="../php/extra/controlador_actividades/Actualizar.php" method="POST" enctype="multipart/form-data">
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                          <center>
                            <?php if (!empty($nombreActividad)) {
                              echo "<input type='submit' class='btn btn-primary btn-lg' name='actividad' value='Actualizar'>";
                            } elseif (empty($nombreActividad)) {
                              echo "<input type='submit' class='btn btn-primary btn-lg' name='actividad' value='Registrar'>";
                            } ?>
