...
if (isset($_POST['buscar'])) {
  ...
  $actividades = mysqli_query($conexion, "SELECT title, ruta_doc FROM events INNER JOIN evidencia ON events.id = evidencia.id_evento WHERE evidencia.numero_control = '$matricula_buscar'");
