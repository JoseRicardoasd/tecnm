                                ...
                                <div class="row">
                                  ...
                                  <form action="" method="GET">
                                    <div class="col-md-6">
                                      ...
                                      <input class="form-control" type="search" style="width: 150px; border: 1px #000000 solid" name="caja_busqueda" id="caja_busqueda" maxlength="50">
