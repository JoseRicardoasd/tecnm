...
$inserta = "INSERT INTO tb_usuarios(nombres, ap_paterno, ap_materno, numero_control, correo, contrasenia, user_creacion, fyh_creacion, estado, cargo) VALUES ('$nombres', $ap_paterno, $ap_materno, '$numero_control', '$correo', '$contraseña', '$user_creacion', '$fechaHora', '$estado', '$cargo')";
