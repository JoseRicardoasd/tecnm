...
if (!file_exists('Concurso de Creatividad e innovación')) {
  ...
  if (file_exists('Concurso de Creatividad e innovación')) {
    if (file_exists('Concurso de Creatividad e innovación/' . $num_control . '-' . $nombre_alumno . '-' . $id_act . '-' . 'CreatividadEinnovación.pdf')) {
      echo '<script language="javascript">alert("El archivo ya existe");window.location.href="../agregar-credito-user.php"</script>';
    } else {
      if (move_uploaded_file($guardado, 'Concurso de Creatividad e innovación/' . $num_control . '-' . $nombre_alumno . '-' . $id_act . '-' . 'CreatividadEinnovación.pdf')) {

        $inserta = "INSERT INTO evidencia(numero_control, id_evento, subido, ruta_doc , responsable) VALUES ('$num_control', '$id_act', 1, 'Concurso de Creatividad e innovación/$num_control-$nombre_alumno-$id_act-CreatividadEinnovación.pdf', '$responsable')";
